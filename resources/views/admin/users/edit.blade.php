                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="password" name="password" id="password" class="form-control" placeholder="Password">	
                                  <span>To change password ypu have to enter a value, otherwise leave blank</span>
                                <p></p>
                            </div>
                        </div>	
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input value="{{$user->phonenumber}}" type="text" name="phonenumber" id="phonenumber" class="form-control" placeholder="Phone">	
                               <p></p>
                            </div>
                        </div>	
                        <div class="col-md-12">
