      ...
      $("#category").change(function(){
        ...
        $.ajax({
            ...
            success: function(response){        
                ...
                $("#sub_category").find('option').not(":first").remove(); // Xóa tất cả các option trừ option đầu tiên
                $.each(response["subCategories"], function(key, item) {
                     $("#sub_category").append(`<option value="${item.id}">${item.name}</option>`); // Thêm option mới
              });
